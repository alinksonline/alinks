...
export function PricingSection() {
  return (
    <section id="pricing" className="relative scroll-mt-16 border-t border-brand-ink/5 dark:border-white/5 bg-brand-surface dark:bg-[#050505] py-16 transition-colors">
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-brand-surface to-brand-cream dark:from-[#050505] dark:to-[#08080c]"
        aria-hidden
      />
