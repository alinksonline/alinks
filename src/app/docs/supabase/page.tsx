    ...
    <article className="prose-invert space-y-10 text-[15px] leading-relaxed text-zinc-300">
      <header className="space-y-3 border-b border-white/10 pb-8">
        ...
        <p className="font-mono text-[11px] text-zinc-500">
          Public URL: https://alinks.online/docs/supabase · Updated for partner review
        </p>
      </header>
  ...
  └── no end-customer order/patient rows`}
      ...
      <Section id="links" title="11. Product links">
        <ul className="list-disc space-y-1 pl-5 text-zinc-400">
          ...
          <li>
            This document:{" "}
            <Link href="/docs/supabase" className="text-teal-400 underline">
              https://alinks.online/docs/supabase
            </Link>
          </li>
        </ul>
      </Section>
