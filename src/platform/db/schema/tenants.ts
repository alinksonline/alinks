...
export const tenants = pgTable("tenants", {
  ...
  /**
   * Exclusive platform role (DB source of truth). One value only:
   * - tenant = platform client (business owner) — cannot be superadmin
   * - superadmin = Artix operator — cannot be a tenant/client
   */
