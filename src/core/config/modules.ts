...
export const MODULE_CATALOG: readonly ModuleDef[] = [
  ...
  },
  {
    ...
    description: "1:1 / batch slots via appointments core.",
    category: "booking",
    industryAllowlist: ["education"],
    includedInWebsite: false,
    monthlyPrice: 199,
  ...
  },
  {
    ...
    description: "Optional online membership fee via tenant Razorpay (pay-then-book pattern).",
    category: "booking",
    industryAllowlist: ["fitness"],
    includedInWebsite: false,
    monthlyPrice: 199,
  ...
  },
  {
    ...
    name: "Wholesale B2B",
    description: "Trade mode wholesale/both + MOQ notes on catalogue. Not multi-outlet POS.",
    category: "commerce",
    industryAllowlist: ["retail"],
    includedInWebsite: false,
    monthlyPrice: 399,
