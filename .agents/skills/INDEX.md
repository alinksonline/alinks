...
Legal/compliance skills live in `legal/skills/`; symlinked here for **Google Antigravity** agent discovery (not Cursor rules).
...
DevOps/review skills live in `integration_setup_docs/skills/`; symlinks in `.agents/skills/` for agent discovery.
